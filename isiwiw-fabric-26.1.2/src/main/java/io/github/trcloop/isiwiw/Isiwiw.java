package io.github.trcloop.isiwiw;
...
public class Isiwiw extends Object
{
	...
	private static @Internal Isiwiw INSTANCE;
	private final IsiwiwConfig config;
	// --------------------------------------------------
	...
	//
	private static final boolean isServer(Isiwiw arg0) { return arg0 instanceof io.github.trcloop.isiwiw.server.IsiwiwServer; }
	private static final boolean isClient(Isiwiw arg0) { return arg0 instanceof io.github.trcloop.isiwiw.client.IsiwiwClient; }
	// ==================================================
	static
	{
		//find mod info
