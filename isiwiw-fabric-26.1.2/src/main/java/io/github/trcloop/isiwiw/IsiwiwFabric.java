...
{
	// ==================================================
	public @Override void onInitializeClient() { new io.github.trcloop.isiwiw.client.IsiwiwClient(); }
	public @Override void onInitializeServer() { new io.github.trcloop.isiwiw.server.IsiwiwServer(); }
	// ==================================================
}
